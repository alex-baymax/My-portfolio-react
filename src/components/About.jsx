    ...
    >
      <div className="flex flex-col items-center justify-center w-full h-full">
        ...
        <div className="max-w-[1000px] w-full grid sm:grid-cols-2 gap-8 px-4">
          {/* Profile picture */}
          <div className="flex items-center justify-center" data-aos="fade-right" data-aos-duration="800" data-aos-easing="linear">
            <img
              src={pic}
              alt="Vsevolod Khokhlov"
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="text-sm leading-7">
              Junior Full Stack developer and UI/UX designer, passionate about
              creating beautiful user experiences. Combining Full Stack development
            ...
            <div className="mt-4">
              ...
              >
                Download resume{" "}
                <span className="duration-300 group-hover:translate-y-1">
